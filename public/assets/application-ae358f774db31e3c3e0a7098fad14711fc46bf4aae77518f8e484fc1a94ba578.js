...
var BkColumn = React.createClass({
  displayName: "BkColumn",

  render: function () {
    var stringLength = this.props.stringLength;
    return React.createElement(
      "div",
      { className: "bk-column col-sm-" + this.props.colWidth },
      this.props.threeTitles.map(function (title) {
        ...
        return React.createElement(
          BkBox,
          { src: info[title].src, url_ending: title, alt: info[title].alt, key: info[title].alt, title: info[title].title, pics: info[title].pics, article_type: info[title].article_type },
          React.createElement(
            "p",
            { className: "bk-box__blurb" },
            React.createElement(
              "span",
              { className: "bk-box__ellipsis" },
              ". . ."
            ),
            main_blurb
          )
...
var BkFeatureArticle = React.createClass({
  ...
  render: function () {
    ...
    return React.createElement(
      'div',
      { className: 'bk-feature-article row' },
      React.createElement(
        'a',
        { href: path },
        React.createElement(
          'div',
          { className: 'bk-box__img-container col-sm-8' },
          React.createElement(
            'div',
            { className: 'bk-box__img-container--inner' },
            React.createElement('img', { src: this.props.src, alt: this.props.alt, height: 'auto', width: '100%' })
          )
        ),
        React.createElement(
          'div',
          { className: 'bk-box__feature-note-container col-sm-4' },
          React.createElement(
            'p',
            { className: 'bk-box__feature-title' },
            this.props.title
          ),
          this.props.children,
          ...
          React.createElement(
            'div',
            { className: 'bk-feature-article__read_more' },
...
var BkFilters = React.createClass({
  ...
  render: function () {
    return React.createElement(
      "div",
      { className: "bk-filters__row row" },
      React.createElement(
        "div",
        { className: "bk-filters__container col-sm-10 col-sm-offset-1 col-xs-12 col-xs-offset-0" },
        React.createElement(
          Link,
          { to: "/articles/everything" },
          React.createElement(
            "div",
            { onClick: this.setFilter.bind(null, 'everything'), className: this.state.filterBy == 'everything' ? "col-sm-3 col-xs-3 bk-filters__option -selected" : "col-sm-3 col-xs-3 bk-filters__option" },
            "All"
          )
        ),
        React.createElement(
          Link,
          { to: "/articles/getayways" },
          React.createElement(
            "div",
            { onClick: this.setFilter.bind(null, 'getayways'), className: this.state.filterBy == 'getayways' ? "col-sm-3 col-xs-3 bk-filters__option -selected" : "col-sm-3 col-xs-3 bk-filters__option" },
            "Near"
          )
        ),
        React.createElement(
          ...
          React.createElement(
            "div",
            { onClick: this.setFilter.bind(null, 'treks'), className: this.state.filterBy == 'treks' ? "col-sm-3 col-xs-3 bk-filters__option -selected" : "col-sm-3 col-xs-3 bk-filters__option" },
            "Far"
          )
        ),
        React.createElement(
          ...
          React.createElement(
            "div",
            { onClick: this.setFilter.bind(null, 'lifestyle'), className: this.state.filterBy == 'lifestyle' ? "col-sm-3 col-xs-3 bk-filters__option -selected" : "col-sm-3 col-xs-3 bk-filters__option" },
            "Lifestyle"
          )
        )
      )
...
var BkHome = React.createClass({
  ...
  render: function () {
    ...
    return React.createElement(
      'div',
      { className: 'bk-home-container', style: bkHomeContainerStyle },
      React.createElement(
        'div',
        { className: 'bk-home__center' },
        React.createElement(
          Link,
          { to: '/articles/everything' },
          React.createElement(
            'h1',
            { className: 'bk-header__title -home' },
            React.createElement(
              'span',
              { className: '-field' },
              'Field '
          ...
          React.createElement(
            'p',
            { className: 'bk-home__enter bk-home__faded' },
            'ENTER'
          )
        )
      ),
      React.createElement(
        'div',
        { className: 'bk-home__bottom_left bk-home__faded' },
        React.createElement(
          'a',
          { href: this.state.bgItem[2] },
          React.createElement(
            'p',
            null,
            this.state.bgItem[1]
      ...
      React.createElement(
        'div',
        { className: 'bk-home__bottom_right' },
        React.createElement(
          'div',
          { className: 'bk-home-circle bk-home__faded', onClick: this.nextPic },
  ...
  render: function () {
    return React.createElement(
      ...
      React.createElement(
        ...
        React.createElement(
          "div",
          { className: "bk-header row" },
          React.createElement(
            "h1",
            { className: "bk-header__title" },
            React.createElement(
              "span",
              { className: "-field" },
              "Field "
          ...
          React.createElement(
            "div",
            { className: "bk-ellipsis" },
            ". . ."
          )
        )
      ),
      React.createElement(BkFilters, { filter: this.props.filter })
    );
  }
});
  ...
  render: function () {
    return React.createElement(
      ...
      this.props.threeTitles.map(function (title) {
        ...
        return React.createElement(
          "div",
          { className: "bk-article-row__box col-sm-4", key: title },
          React.createElement(
            BkBox,
            { src: info[title].src, url_ending: title, alt: info[title].alt, key: info[title].alt, title: info[title].title, pics: info[title].pics, article_type: info[title].article_type },
            React.createElement(
...
var BkShow = React.createClass({
  ...
  render: function () {
    ...
    return React.createElement(
      'div',
      null,
      React.createElement(BkMainHeader, { path: '#articles/everything' }),
      React.createElement(
        'div',
        { className: 'bk-show__title -center', onClick: this.switchMode },
        info[this.props.params.name].title
      ),
      React.createElement(
        'div',
        { className: 'bk-show__gallery', onClick: this.switchMode },
        'View gallery'
      ),
      this.state.galleryMode ? React.createElement(
        'div',
        { className: 'col-sm-9' },
        React.createElement(
          'div',
          { className: 'bk-show__main-image' },
          React.createElement(GalleryNav, { prevPic: this.prevPic, nextPic: this.nextPic, picCount: info[this.props.params.name].pics.length }),
          React.createElement('img', { src: this.state.activePic[0], alt: 'bug', width: '100%', height: '90%' }),
          React.createElement(BkShowThumbs, { pics: info[this.props.params.name].pics, setActivePic: setActivePic, activePic: activePic }),
          React.createElement(
            'div',
            { className: 'bk-show__image-blurb js-show__image-blurb' },
            this.state.activePic[2]
          )
        )
      ) : React.createElement(
        'div',
        { className: 'bk-show__main-image col-sm-9' },
        this.state.all_pics.map(function (pic) {
          return React.createElement(
            'div',
            null,
            React.createElement('img', { src: pic[0], alt: 'pic', width: '100%', height: '90%' }),
            React.createElement(
              'p',
              { className: 'bk-show__image-blurb js-show__image-blurb' },
              pic[2]
      ...
      React.createElement(
        'div',
        { className: 'bk-show__title -center col-sm-3' },
        'More articles'
      ),
      React.createElement(BkColumn, { threeTitles: this.state.recommendations, colWidth: '3', stringLength: '75' })
    );
  }
});
var BkShowSlidShow = React.createClass({
  displayName: 'BkShowSlidShow',
  ...
  render: function () {
    ...
    return React.createElement(
      ...
      React.createElement(
        'div',
        { className: 'bk-show__title -center' },
        info[this.props.params.name].title
      ),
      React.createElement(
        'div',
        ...
        React.createElement(
          'div',
          { className: 'bk-show__main-image -slide-show' },
          React.createElement(GalleryNav, { prevPic: this.prevPic, nextPic: this.nextPic, picCount: info[this.props.params.name].pics.length }),
          React.createElement('img', { src: this.state.activePic, alt: 'bug', className: 'img-responsive', width: '100%', height: '90%' })
        ),
        React.createElement(
          'div',
          { className: 'bk-show__image-blurb -slide-show js-show__image-blurb' },
          info[this.props.params.name]['blurb']
        ),
        recipe.length ? React.createElement(
          'div',
          { className: 'bk-show__recipe--container' },
          React.createElement(
            'div',
            { className: 'col-sm-6' },
            React.createElement(
              'dl',
              { className: 'bk-show__recipe js-show__recipe' },
          ...
          instructions != "[]" ? React.createElement(
            'div',
            { className: 'bk-show__instructions js-show__image-blurb col-sm-6' },
            instructions
          ) : false
        ) : false
      ),
...
var BkShowThumbs = React.createClass({
  ...
  render: function () {
    ...
    return React.createElement(
      "div",
      { className: "bk-show__small-images row" },
      this.props.pics.map(function (data) {
        return React.createElement(
          "div",
          { key: data[1], className: activePic == data ? "bk-show__small-image -selected" : "bk-show__small-image", onClick: setActivePic.bind(null, data) },
          React.createElement("img", { src: data[1], alt: data[2], height: "71px", width: "71px" })
        );
      })
    );
  }
...
var BodyContent = React.createClass({
  ...
  render: function () {
    ...
    return React.createElement(
      'div',
      null,
      React.createElement(BkMainHeader, { filter: filter, path: '/' }),
      filter == 'everything' ? React.createElement(
        BkFeatureArticle,
        { src: info[featureTitle].feature_img_src, alt: featureTitle, key: featureTitle, title: info[featureTitle].title, pics: info[featureTitle].pics, article_type: info[featureTitle].article_type },
        info[featureTitle].main_blurb
      ) : false,
      titles_in_threes.map(function (three_titles) {
        return React.createElement(BkColumn, { key: three_titles[0], threeTitles: three_titles, colWidth: '6', stringLength: '275' });
      })
    );
  }
});
var GalleryNav = React.createClass({
  displayName: 'GalleryNav',
  ...
  render: function () {
    ...
    return React.createElement(
      'div',
      { className: "bk-show__nav-item-container " + modifier },
      React.createElement(
        'a',
        { className: "bk-show__nav-item -home " + modifier, href: '#articles/everything' },
        React.createElement('i', { className: 'fa fa-home' })
      ),
      multiple_pics ? React.createElement(
        'div',
        null,
        React.createElement(
          'div',
          { className: 'bk-show__nav-item -prev', onClick: this.props.prevPic },
          React.createElement('i', { className: 'fa fa-angle-left' })
        ),
        React.createElement(
          'div',
          { className: 'bk-show__nav-item -next', onClick: this.props.nextPic },
          React.createElement('i', { className: 'fa fa-angle-right' })
        )
      ) : false
    );
...
var SlideShowNav = React.createClass({
  displayName: "SlideShowNav",

  render: function () {
    if (this.props.picCount > 1) {
      var nextPrev = React.createElement(SlideShowNavNextPrev, { nextPic: this.props.nextPic, prevPic: this.props.prevPic });
    } else {
      var nextPrev = '';
    }
    return React.createElement(
      ...
      React.createElement(
        "div",
        { className: "bk-show__nav-item-container -home -slide-show bk-show__hide-til-hover" },
        React.createElement(
          "a",
          { className: "bk-show__nav-item -home -slide-show", href: "#articles/everything" },
          React.createElement("i", { className: "fa fa-home" })
        )
      ),
      nextPrev
...
var SlideShowNavNextPrev = React.createClass({
  displayName: "SlideShowNavNextPrev",
  ...
  render: function () {
    return React.createElement(
      ...
      React.createElement(
        "div",
        { className: "bk-show__nav-item-container -prev -slide-show bk-show__hide-til-hover" },
        React.createElement(
          "div",
          { className: "bk-show__nav-item -prev -slide-show bk-show__hide-til-hover", onClick: this.props.prevPic },
          React.createElement("i", { className: "fa fa-angle-left" })
        )
      ),
      React.createElement(
        "div",
        { className: "bk-show__nav-item-container -next -slide-show bk-show__hide-til-hover" },
        React.createElement(
          "div",
          { className: "bk-show__nav-item -next -slide-show bk-show__hide-til-hover", onClick: this.props.nextPic },
          React.createElement("i", { className: "fa fa-angle-right" })
        )
      )
    );
...
this.MyRoutes = React.createElement(
  Route,
  { name: "home", path: "/", handler: App },
  React.createElement(DefaultRoute, { handler: BkHome }),
  React.createElement(
    Route,
    { path: "articles", handler: BodyContent },
    React.createElement(Route, { path: ":filter", handler: BodyContent })
  ),
  React.createElement(
    Route,
    { path: "article" },
    React.createElement(Route, { path: ":name", handler: BkShow })
  ),
  React.createElement(
    Route,
    { path: "slide_show" },
    React.createElement(Route, { path: ":name", handler: BkShowSlidShow })
  )
);
