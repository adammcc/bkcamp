...
var homeImages = [
  ['assets/livingston_manor/home_image/livingston_manor__home.jpeg', 'bottom', 'Livingston Manor', '#article/livingston_manor'],
  ['assets/filson/home_image/filson_1.JPG', 'bottom', 'Filson', '#article/filson'],
  ['assets/spain/home_image/spain__home.jpg', 'bottom', 'Spain', '#article/spain'],
  ['assets/newport/home_image/newport_light_house__home.JPG', 'bottom', 'Newport', '#article/newport'],
  ['assets/finger_lakes/home_image/finger_lakes_upstate_bug_home.JPG', 'bottom', 'The Finger Lakes', '#article/finger_lakes'],
  ['assets/mohonk/home_image/mountain_house_home.JPG', 'bottom', 'Mohonk Mountain House', '#article/mohonk'],
  ['assets/new_haven/home_image/new_haven_grass__home.JPG', 'bottom', 'New Haven', '#article/new_haven'],
  ['assets/hoot/home_image/hoot_home.JPG', 'bottom', 'Hoot', '#article/hoot'],
  ['assets/bear_mountain/home_image/bear_mountain_lake__home.JPG', 'bottom', 'Bear Mountain', '#article/bear_mountain'],
  ['assets/hudson/home_image/hudson_winter_walk__home.JPG', 'bottom', 'Hudson Winter Walk', '#article/hudson_winter_walk'],
  ['assets/nyack/home_image/nyack_hook_mt_tree__home.JPG', 'bottom', 'Nyack', '#article/nyack'],
  ['assets/storm_king/home_image/storm_king_tree__home.JPG', 'bottom', 'Storm King', '#article/storm_king'],
  ['assets/scotland/home_image/scotch_old_man_store__home.jpg', 'bottom', 'Scotland', '#article/scotland'],
  ['assets/saugerties/home_image/saugerties_light_house.jpg', 'bottom', 'Saugerties', '#article/saugerties'],
  ['assets/mv/home_image/marthas_vineyard_creek__home.JPG', 'bottom', 'Marthas Vineyard', '#article/marthas_vineyard']
]